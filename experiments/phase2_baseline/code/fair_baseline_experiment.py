...
from experiments.phase2_baseline.code.baseline_models import create_baseline_model
# Import helper functions from phase 1 code (since we moved them there) or original?
# evaluate_model_detailed was in ablation_experiment.py which we moved.
# So we must import it from experiments.phase1_ablation.code.ablation_experiment 
from experiments.phase1_ablation.code.ablation_experiment import evaluate_model_detailed, generate_ablation_report
from experiment_v2.data_loaders import load_all_datasets

def run_baseline_experiment(datasets: Dict[str, List[Dict]], 
                            output_dir: str = 'experiments/phase2_baseline/results',
...
if __name__ == "__main__":
    ...
    metrics = run_baseline_experiment(
        datasets=datasets,
        output_dir='experiments/phase2_baseline/results'
    )
